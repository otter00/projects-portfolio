    ...
    <div className={headerStyles.header__container}>
      ...
      <div className={headerStyles.header__info}>
        ...
        <span className={headerStyles.header__about}>
          ...
          которых 1,5 года участия в групповых проектах и реального проекта на
          стажировке в крупной компании. В этом портфолио я собрала те проекты,
          которыми горжусь больше всех.
        </span>
      </div>
    </div>
  );
